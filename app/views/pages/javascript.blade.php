...
<p>1. Wybór daty:
    <input type="text" id="datepicker" class="button"
           value="Klik mnie!" title="No kliknij." />
</p>
<p>2. Dymki tekstowe:
...
<div id="tabs" class="ui-tabs" style="visibility: hidden">
    ...
    <div id="tabs-1">
        <p>
            <strong>Możesz zmieniać kolejność zakładek za pomocą
                "przeciągnij i upuść".</strong>
        </p>
        <p>Super łacina. Proin elit arcu, rutrum commodo, vehicula tempus,
    ...
    <div id="tabs-2">
        <p>Jeszcze bardziej super łacina. Morbi tincidunt, dui sit amet
            facilisis feugiat, odio metus gravida ante, ut pharetra massa metus
            id nunc. Duis scelerisque molestie turpis. Sed fringilla, massa eget
            luctus malesuada, metus eros molestie lectus, ut tempus eros massa
            ut dolor. Aenean aliquet fringilla sem. Suspendisse sed ligula in
    ...
    <div id="tabs-3">
        <p>Najbardziej super łacina. Znowu. Duis cursus. Maecenas ligula eros,
            blandit nec, pharetra at, semper at, magna. Nullam ac lacus. Nulla
            facilisi. Praesent viverra justo vitae neque. Praesent blandit
            adipiscing velit. Suspendisse potenti. Donec mattis, pede vel
            pharetra blandit, magna ligula faucibus eros, id euismod lacus dolor
            eget odio. Nam scelerisque. Donec non libero sed nulla mattis
            commodo. Ut sagittis. Ehehe. Donec nisi lectus, feugiat porttitor,
            tempor ac, tempor vitae, pede. Aenean vehicula velit eu tellus
            interdum rutrum. Maecenas commodo. Pellentesque nec elit. Fusce in
