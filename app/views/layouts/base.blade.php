...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        @section('head')
        <link href='//fonts.googleapis.com/css?family=Open+Sans:400,700&amp;subset=latin-ext'
              rel='stylesheet'>
    ...
    <body>
        ...
        informacji jakie zamieszczasz w sieci.
          Ochoczo zalecam <a href="//browsehappy.com/">aktualizację</a>
          lub <a href="//www.google.com/chromeframe/?redirect=true">aktywację
        ...
        <div id="main-container">
            ...
            <nav id="lewa-kolumna">
                ...
                <div class="social">
                    <a href="//www.facebook.com/marcin.marcinowy.5"
                       target="_blank">
                        <span class="fb"></span>
                    </a>
                    <a href="//twitter.com/Czarnodziej"
                       target="_blank">
                        <span class="tw"></span>
                    </a>
                    ...
                    <a href="//github.com/Czarnodziej"
                       target="_blank">
                        <span class="gh"></span>
                    </a>
                    <p>
                        <a href="//laravel.com" target="_blank">
                            <img src="{{ asset('assets/img/laravel.png') }}"
                                 alt="laravel logo">
                        </a>
                    </p>
                    <p>
                        <a href="//www.phptherightway.com" target="_blank">
                            <img src="//www.phptherightway.com/images/banners/btn1-120x90.png"
            ...
            <footer id="stopka-strony">
                <div class="social">
                    <a href="//www.facebook.com/marcin.marcinowy.5" target="_blank">
                        <span class="fb"></span>
                    </a>
                    <a href="//twitter.com/Czarnodziej" target="_blank">
                        <span class="tw"></span>
                    </a>
                    <a href="{{ URL::route('kontakt') }}">
                        <span class="mail"></span>
                    </a>
                    <a href="//github.com/Czarnodziej" target="_blank">
                        <span class="gh"></span>
                    </a>
                </div>
