...
MyGame.failCounter+=1;MyGame.spanTotal.innerHTML=MyGame.totalCounter;MyGame.setSpeed();c.className="";}else{c.className="";MyGame.failCounter-=1;MyGame.spanFail.innerHTML=MyGame.failCounter;
if(MyGame.spanFail.innerHTML<0){MyGame.spanFail.innerHTML=0;}}};}};MyGame.startBtn.onclick=function(){MyGame.spanTotal.innerHTML=0;MyGame.spanSpeed.innerHTML=1;
MyGame.spanFail.innerHTML=5;var a=setInterval(function(){if(MyGame.failCounter>0){MyGame.randomCellColor();}else{clearInterval(a);alert("Liczba punktów = "+MyGame.totalCounter);
MyGame.totalCounter=0;MyGame.failCounter=5;}},1000);MyGame.cancelBtn.onclick=function(){clearInterval(a);MyGame.spanTotal.innerHTML=0;MyGame.spanSpeed.innerHTML=1;
MyGame.spanFail.innerHTML=5;alert("Liczba punktów = "+MyGame.totalCounter);MyGame.totalCounter=0;MyGame.failCounter=5;};};